...
from app6.enum.affiliation import Affiliation
from app6.enum.battle_dimension import BattleDimension
from app6.svg_shape.hostile_shapes import hostile_color
...
def get_SIDC_from_hierarchy(hierarchy):
    try:
        with open('APP6-icons/icon-files-mapping.csv', 'r') as file:
