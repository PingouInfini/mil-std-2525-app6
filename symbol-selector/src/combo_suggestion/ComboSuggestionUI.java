...
public class ComboSuggestionUI extends BasicComboBoxUI {
    ...
    public void installUI(JComponent jc) {
        ...
        List<String> keyys = null;

        AutoCompleteDecorator.decorate(txt, , false);
    ...
    // Convertisseur personnalisé pour la recherche "contient le texte"
    private static class ContainsTextConverter extends ObjectToStringConverter {
        @Override
        public String getPreferredStringForItem(Object item) {
            return item.toString(); // Utilisez toString() par défaut
        }

//        @Override
//        public Object[] getPossibleStringsForItem(Object item) {
//            return new Object[]{item.toString()}; // Utilisez toString() par défaut
//        }
    }
    @Override
