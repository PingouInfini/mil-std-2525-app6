...
import fr.pingouinfini.symbology.MilitarySymbol;
import fr.pingouinfini.symbology.ModifierTypes;
import fr.pingouinfini.symbology.StatusAmplifierModes;
import fr.pingouinfini.symbology.SymbolSets;
 ...
 * <a href="https://github.com/Esri/joint-military-symbology-xml">...</a>
 * @author Yemi Kudaisi
 *
 */
public class ResourceManager {
	...
	private static final String CODED_DOMAIN_AREA_ENTITIES_FILE_SUFFIX = "_Area_Entities";
	private static final String CODED_DOMAIN_LINE_ENTITIES_FILE_SUFFIX = "_Line_Entities";
	private static final String CODED_DOMAIN_POINT_ENTITIES_FILE_SUFFIX = "_Point_Entities";
	...
	private void initCsvDomainCodeMapping() {
		symbolSetToCsvFileNameMap = new HashMap<>();
	 ...
	 * @param milSym The military symbols whose frame SVG resource path is to be generated
	 * @return filename
	 */
	protected static String getFrameSvgResourcePath(MilitarySymbol milSym) {
        ...
        fileName = switch (milSym.getStandardEntityOne()) {
            case Exercise -> EXERCISE_FRAMES_FOLDER + fileName + ".svg";
            case Simulation -> SIMULATION_FRAMES_FOLDER + fileName + ".svg";
            default -> FRAMES_SVG_FOLDER + fileName + ".svg";
        };
	 ...
	 * 
	 * @param milSym The military symbols whose status SVG resource path is to be generated
	...
	protected static String getStatusSvgResourcePath(MilitarySymbol milSym){
		...
		switch (c[3]) {
			case '0': // Standard entity value pending (SIDC value 5) use resource for hostile (SIDC value 6)
				c[3] = '1';
				break;
			case '2': // Standard entity value assumed friend (SIDC value 3) use resource for friend (SIDC value 3)
				c[3] = '3';
				break;
			case '5': // Standard entity value suspect (SIDC value 5) use resource for hostile (SIDC value 6)
				c[3] = '6';
				break;
		}
	 ...
	 * value '6' (Hostile/Faker) </p>
	 * 
	 * @param milSym The military symbols whose Amplifier SVG resource path is to be generated
	 ...
	 * _2 = Neutral
	 * _3 = Hostile
	 * @param milSym MilitarySymbol
	 * @return List<String> pathsWithExtension
	 */
	protected static List<String> getEntitySvgResourcePath(MilitarySymbol milSym) {
		...
		// Consider entity subtype '9x' (SIDC position 15-16) which adds an extra symbol
	 ...
	 */
	protected String getAreaEntitiesCsvResourcePath(SymbolSets symbolSets) {
		return NAME_DOMAIN_VALUES_FOLDER+
				CODED_DOMAIN_FILE_PREFIX+
				symbolSetToCsvFileNameMap.get(symbolSets)+
				CODED_DOMAIN_AREA_ENTITIES_FILE_SUFFIX +
				".csv";
	}
	 ...
	 */
	protected String getLineEntitiesCsvResourcePath(SymbolSets symbolSets) {
		return NAME_DOMAIN_VALUES_FOLDER+
				CODED_DOMAIN_FILE_PREFIX+
				symbolSetToCsvFileNameMap.get(symbolSets)+
				CODED_DOMAIN_LINE_ENTITIES_FILE_SUFFIX +
				".csv";
	}
	 ...
	 */
	protected String getPointEntitiesCsvResourcePath(SymbolSets symbolSets) {
		return NAME_DOMAIN_VALUES_FOLDER+
				CODED_DOMAIN_FILE_PREFIX+
				symbolSetToCsvFileNameMap.get(symbolSets)+
				CODED_DOMAIN_POINT_ENTITIES_FILE_SUFFIX +
				".csv";
	}
	...
	/**
	 * Gets the file at the supplied resource path
	 * 
	...
	protected static File getResourceFile(String resourcePath) {
		String s = Objects.requireNonNull(ResourceManager.class.getClassLoader().getResource(resourcePath)).getFile();
		return new File(s);
	}
