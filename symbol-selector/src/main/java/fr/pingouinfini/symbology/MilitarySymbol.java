...
public class MilitarySymbol
{
    ...
    public String getSidcSetB() {
        return getEntity().getIdentifier().substring(0,2)+
	...
	public void setContext(StandardEntityOnes standardEntityOne) {
		setStandardEntityOne(standardEntityOne);
	}
	...
	public void setStandardEntity(StandardEntityTwos standardEntityTwo) {
		setStandardEntityTwo(standardEntityTwo);
	}
