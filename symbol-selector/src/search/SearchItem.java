...
public class SearchItem extends javax.swing.JPanel {
    ...
    private void lbRemoveMouseClicked() {//GEN-FIRST:event_lbRemoveMouseClicked
        if (!lbRemove.getText().trim().isEmpty()) {
            eventRemove.actionPerformed(null);
        }
    }//GEN-LAST:event_lbRemoveMouseClicked

    private void lbTextMouseClicked() {//GEN-FIRST:event_lbTextMouseClicked
